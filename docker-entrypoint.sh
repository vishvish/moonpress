...
if [[ "$1" == apache2* ]] || [ "$1" == php-fpm ]; then
    ...
    if ! grep -Fxq "require_once __DIR__.\"/../../../wp-content/vendor/autoload.php\";" /usr/src/wordpress/wp-content/plugins/graphql-wp/index.php
    then
      sed -i '/namespace Mohiohio\\GraphQLWP;/a require_once __DIR__."/../../../wp-content/vendor/autoload.php";' /usr/src/wordpress/wp-content/plugins/graphql-wp/index.php
    fi


    sed -i '/<?php/a require __DIR__ . "/wp-content/vendor/autoload.php";' /usr/src/wordpress/wp-config-sample.php
